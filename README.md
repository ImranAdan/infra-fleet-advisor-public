...
The Kubernetes checks evaluate what each deployment profile actually applies:
the advisor renders the profiles itself, without running kustomize or fleet
code. A control must hold in every rendered profile; see
